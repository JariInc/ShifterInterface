...
driver. It configures V-USB for USB D+ connected to Port B bit 1 and USB D- to Port B bit 0. 
You may wire the lines to any other port, as long as D+ is also wired to INT0 (or any
...
#define USB_CFG_VENDOR_NAME     'j', 'a', 'r', 'i', 'i', 'n', 'c'
...
#define USB_CFG_DEVICE_NAME     'S', 'e', 'q', 'u', 'e', 'n', 't', 'i', 'a', 'l', ' ', 's', 'h', 'i', 'f', 't', 'e', 'r'
